...
export const registerUser = ({ name, lastname, email, password,studentUniversity }) => async (
  dispatch
) => {
  const config = {
    headers: {
  ...
  console.log("🦹🏼‍♂️"+studentUniversity["id"])
  
  const body = JSON.stringify({ name, lastname, email, password,studentUniversity });
