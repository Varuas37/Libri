...
const Register = ({
  ...
  const onSubmit = async data => {
    const { name, lastname, email, password, password2, studentUniversity } = data

    registerUser({ name, lastname, email, password, password2, studentUniversity})
  ...
  <select name="university" ref={register}>
       {!university.loading?
        university.universities.map((item)=>(
